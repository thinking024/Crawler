...
%>
    ...
    <table class="table table-hover">
              ...
              <tbody>
                  <%for (User user : users) { %>
                  <tr>
                      <td width="150px"><a style="color:#F9C " href=<%=user.getHref() %> ><%=user.getName() %> <span class="badge badge-primary"><%=user.getVerify()%></span></a></td>
                      <td width="100px"><%=user.getLv()%></td>
                      <td width="100px"><%=user.getVideos()%></td>
                      <td width="100px"><%=user.getFans()%></td>
